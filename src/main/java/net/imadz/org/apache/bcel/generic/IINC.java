...
public class IINC extends LocalVariableInstruction {
    ...
    public IINC(int n, int c) {
        ...
        this.opcode = net.imadz.org.apache.bcel.Constants.IINC;
        this.length = (short) 3;
    ...
    public void dump( DataOutputStream out ) throws IOException {
        if (wide) {
            out.writeByte(net.imadz.org.apache.bcel.Constants.WIDE);
        }
    ...
    private final void setWide() {
        wide = (n > net.imadz.org.apache.bcel.Constants.MAX_BYTE) || (Math.abs(c) > Byte.MAX_VALUE);
        if (wide) {
