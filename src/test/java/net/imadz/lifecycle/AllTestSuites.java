...
import net.imadz.lifecycle.engine.EngineTestSuite;
import net.imadz.lifecycle.semantics.SemanticsTestSuite;
import net.imadz.lifecycle.syntax.SyntaxTestSuite;
