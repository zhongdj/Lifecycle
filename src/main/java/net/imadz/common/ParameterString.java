...
public class ParameterString {
   ...
   *
   * @param separator String used to separate values (default constructor uses ", ")
   * @param name      Name of this parameter string, or null for an unnamed string
   */
   ...
   *
   * @param key   Value to append to the string
   * @param value Value will only be appended if this value is true
