...
import net.imadz.org.apache.bcel.verifier.statics.Pass1Verifier;
import net.imadz.org.apache.bcel.verifier.statics.Pass2Verifier;
import net.imadz.org.apache.bcel.verifier.statics.Pass3aVerifier;
import net.imadz.org.apache.bcel.verifier.structurals.Pass3bVerifier;
 ...
 *
 * @version $Id: Verifier.java 1151716 2011-07-28 03:58:16Z dbrosius $
 * @author Enver Haase
 * @see net.imadz.org.apache.bcel.verifier.VerifierFactory
 * @see net.imadz.org.apache.bcel.verifier.PassVerifier
 */
        ...
        for (Pass3aVerifier pv : p3avs.values()) {
            ...
            for (int i = 0; i < p3am.length; i++) {
                messages.add("Pass 3a, method " + meth + " ('"
                        + net.imadz.org.apache.bcel.Repository.lookupClass(classname).getMethods()[meth]
                        + "'): " + p3am[i]);
            }
        }
        ...
        for (int k = 0; k < args.length; k++) {
            try {
                ...
                if (vr == VerificationResult.VR_OK) {
                    JavaClass jc = net.imadz.org.apache.bcel.Repository.lookupClass(args[k]);
                ...
                // avoid swapping.
                v.flush();
                net.imadz.org.apache.bcel.Repository.clearCache();
                System.gc();
