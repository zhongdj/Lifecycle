...
import net.imadz.org.apache.bcel.ExceptionConstants;
 ...
 *
 * @version $Id: MULTIANEWARRAY.java 1152072 2011-07-29 01:54:05Z dbrosius $
...
public class MULTIANEWARRAY extends CPInstruction implements LoadClass, AllocationInstruction,
    ...
    public MULTIANEWARRAY(int index, short dimensions) {
        super(net.imadz.org.apache.bcel.Constants.MULTIANEWARRAY, index);
        if (dimensions < 1) {
