 ...
 *
 * @version $Id: InstructionFactory.java 1481383 2013-05-11 17:34:32Z dbrosius $
...
public class InstructionFactory implements InstructionConstants, java.io.Serializable {
    ...
    public Instruction createCast( Type src_type, Type dest_type ) {
        if ((src_type instanceof BasicType) && (dest_type instanceof BasicType)) {
            ...
            String name = "net.imadz.org.apache.bcel.generic." + short_names[src - Constants.T_CHAR] + "2"
