 ...
 *
 * @version $Id: INSTANCEOF.java 1152072 2011-07-29 01:54:05Z dbrosius $
...
public class INSTANCEOF extends CPInstruction implements LoadClass, ExceptionThrower,
    ...
    public INSTANCEOF(int index) {
        super(net.imadz.org.apache.bcel.Constants.INSTANCEOF, index);
    }


    public Class<?>[] getExceptions() {
        return net.imadz.org.apache.bcel.ExceptionConstants.EXCS_CLASS_AND_INTERFACE_RESOLUTION;
    }
