...
public class NEWARRAY extends Instruction implements AllocationInstruction, ExceptionThrower,
    ...
    public NEWARRAY(byte type) {
        super(net.imadz.org.apache.bcel.Constants.NEWARRAY, (short) 2);
        this.type = type;
    }
    ...
    public String toString( boolean verbose ) {
        return super.toString(verbose) + " " + net.imadz.org.apache.bcel.Constants.TYPE_NAMES[type];
    }
    ...
    public Class<?>[] getExceptions() {
        return new Class[] {
            net.imadz.org.apache.bcel.ExceptionConstants.NEGATIVE_ARRAY_SIZE_EXCEPTION
        };
    }
