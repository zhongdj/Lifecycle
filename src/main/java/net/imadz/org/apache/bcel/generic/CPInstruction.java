...
public abstract class CPInstruction extends Instruction implements TypedInstruction,
    ...
    public String toString( ConstantPool cp ) {
        ...
        return net.imadz.org.apache.bcel.Constants.OPCODE_NAMES[opcode] + " " + str;
    }
    ...
    public Type getType( ConstantPoolGen cpg ) {
        ...
        String name = cp.getConstantString(index, net.imadz.org.apache.bcel.Constants.CONSTANT_Class);
        if (!name.startsWith("[")) {
            name = "L" + name + ";";
        }
