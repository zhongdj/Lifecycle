...
public class DCONST extends Instruction implements ConstantPushInstruction {
    ...
    public DCONST(double f) {
        super(net.imadz.org.apache.bcel.Constants.DCONST_0, (short) 1);
        if (f == 0.0) {
            opcode = net.imadz.org.apache.bcel.Constants.DCONST_0;
        } else if (f == 1.0) {
            opcode = net.imadz.org.apache.bcel.Constants.DCONST_1;
        } else {
