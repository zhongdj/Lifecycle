...
public class LDC2_W extends CPInstruction implements PushInstruction {
    ...
    public LDC2_W(int index) {
        super(net.imadz.org.apache.bcel.Constants.LDC2_W, index);
    }
    ...
    public Type getType( ConstantPoolGen cpg ) {
        switch (cpg.getConstantPool().getConstant(index).getTag()) {
            case net.imadz.org.apache.bcel.Constants.CONSTANT_Long:
                return Type.LONG;
            case net.imadz.org.apache.bcel.Constants.CONSTANT_Double:
                return Type.DOUBLE;
    ...
    public Number getValue( ConstantPoolGen cpg ) {
        ...
        switch (c.getTag()) {
            case net.imadz.org.apache.bcel.Constants.CONSTANT_Long:
                return Long.valueOf(((net.imadz.org.apache.bcel.classfile.ConstantLong) c).getBytes());
            case net.imadz.org.apache.bcel.Constants.CONSTANT_Double:
                return new Double(((net.imadz.org.apache.bcel.classfile.ConstantDouble) c).getBytes());
            default: // Never reached
